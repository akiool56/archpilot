...
```bash
git clone https://github.com/akiool56/archpilot.git
```

或者点击 GitHub 页面上的 **Code → Download ZIP** 下载压缩包并解压。
...
Or click **Code → Download ZIP** on the GitHub page and extract the archive.
